"""
Pinterest API - User Account Endpoint (有驗證)
"""
...
class handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        try:
            ...
            response = {'success': True, 'data': user_data, 'message': 'User account retrieved successfully'}
        except Exception as e:
            response = {'success': False, 'error': str(e), 'message': 'Failed to retrieve user account'}
